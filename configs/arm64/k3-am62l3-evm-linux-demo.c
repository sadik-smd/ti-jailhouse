 ...
 *
 * Configuration for Linux inmate on AM62L3 based platforms
 * 1 CPUs, 1018MB RAM, 1 serial port (MAIN UART1)
 *
...
struct {
	...
	.mem_regions = {
		...
		JAILHOUSE_SHMEM_NET_REGIONS(0xc0100000, 1),
		/* RAM load */ {
